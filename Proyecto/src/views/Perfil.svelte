    ...
    <div class="stat-card peso-actual">
      ...
      <div class="stat-info">
        ...
        <div class="stat-value">
          {ultimoRegistro ?
ultimoRegistro.peso : '--'} <span class="unit">kg</span>
        </div>
      </div>
    </div>
...
ultimoRegistro.imc : '--'}
  ...
  <div class="registro-card">
    <h3 class="section-title">Registrar 
nuevo peso</h3>
    ...
    {#if mensaje}
      <div class="mensaje {mensaje.includes('Error') ?
'error' : 'exito'}">
      ...
      <h3 class="section-title">Evolución de peso</h3>
        ...
        <svg width="100%" height="200" viewBox="0 0 600 200">
          ...
          {#each historial as entry, i}
            <circle
              cx={historial.length === 1 ?
300 : 50 + (i / (historial.length - 1)) * 530}
...
300 : 50 + (i / (historial.length - 1)) * 530}
      ...
      <div class="grafica-info">
        <span class="info-icon">ℹ️</span>
          ...
          Mostrando evolución de los últimos {historial.length} registro{historial.length > 1 ?
's' : ''}
      </div>
    </div>
  {/if}
        ...
        <div class="tabla-scroll">
          {#each historial.slice().reverse() as entry, i}
            <div class="registro-item">
              <div class="registro-numero">#{historial.length 
- i}</div>
